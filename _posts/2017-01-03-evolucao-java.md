...
A idéia desse post é apresentar um pouco dos recursos a cada nova release do JDK.   Posteriormente, pretendo abordar 
como a JVM evoluiu e suporta outras linguagens além do Java.
